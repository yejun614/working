...
async function saveCard() {
  ...
  try { await KanbanService.CardSave(card); closeCard(); await refresh(); info.value = '카드가 저장되었습니다.' } catch (e) { error.value = (e as Error).message }
}
